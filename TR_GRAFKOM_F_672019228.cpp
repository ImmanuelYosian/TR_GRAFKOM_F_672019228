...
void tampil(void){
	...
	glBegin(GL_QUADS);
		glVertex3f(10,10,-20);
		glVertex3f(240,10,-20);
		glVertex3f(240,-25,-20);
		glVertex3f(10,-25,-20);
	glEnd();
	//bagian atas
	...
	glBegin(GL_QUADS);
		glVertex3f(5,10,-100);
		glVertex3f(240,10,-100);
		glVertex3f(240,-25,-100);
		glVertex3f(5,-25,-100);
	glEnd();
	//bagian atas
	glColor3f(0.35, 0.16, 0.14);
	...
	glColor3f(0.258824,0.258824,0.435294);
	glBegin(GL_POLYGON);
		glVertex3f(250,70,-100);
		glVertex3f(200,90,-130);
		glVertex3f(200,90,-310);
		glVertex3f(250,70,-340);
	glEnd();
	glBegin(GL_POLYGON);
		glVertex3f(160,70,-100);
		glVertex3f(200,90,-130);
		glVertex3f(200,90,-310);
		glVertex3f(160,70,-280);
	glEnd();
	glBegin(GL_TRIANGLES);
		glVertex3f(200,90,-130);
		glVertex3f(160,70,-100);
	...
	glBegin(GL_POLYGON);
		...
		glVertex3f(0,65,-425);
		glVertex3f(-135,65,-425);
		glVertex3f(-155,50,-390);
	glEnd();
	glBegin(GL_POLYGON);
		glVertex3f(20,50,-465);
		glVertex3f(0,65,-425);
		glVertex3f(-135,65,-425);
		glVertex3f(-155,50,-465);
	glEnd();
	glBegin(GL_TRIANGLES);
		glVertex3f(0,65,-425);
		glVertex3f(20,50,-390);
	...
	glBegin(GL_QUADS);
		glVertex3f(10,10,-400);
		glVertex3f(-205,10,-400);
		glVertex3f(-205,-25,-400);
		glVertex3f(-10,-25,-400);
	glEnd();
	...
	glColor3f(0.35, 0.16, 0.14);
	glBegin(GL_QUADS);
		glVertex3f(-205,70,-450);
		glVertex3f(-205,70,-100);
		glVertex3f(-205,10,-100);
		glVertex3f(-205,10,-450);
	glEnd();
	//kiri samping atas depan
	glColor3f(0.35, 0.16, 0.14);
	glBegin(GL_QUADS);
		glVertex3f(-205,100,-100);
		glVertex3f(-205,100,-20);
		glVertex3f(-205,10,-20);
		glVertex3f(-205,10,-100);
	glEnd();
	//kiri samping
	glColor3f(0.90,0.91,0.98);
	glBegin(GL_QUADS);
		glVertex3f(-155,10,-450);
		glVertex3f(-155,10,-20);
		glVertex3f(-155,-25,-20);
		glVertex3f(-155,-25,-450);
	glEnd();
	//kiri samping atas
	glColor3f(0.35, 0.16, 0.14);
	glBegin(GL_QUADS);
		glVertex3f(-155,70,-450);
		glVertex3f(-155,70,-100);
		glVertex3f(-155,10,-100);
		glVertex3f(-155,10,-450);
	glEnd();
	//kiri samping atas
	glBegin(GL_QUADS);
		glVertex3f(-155,100,-100);
		glVertex3f(-155,100,-20);
		glVertex3f(-155,10,-20);
		glVertex3f(-155,10,-100);
	glEnd();
	//atap
	glColor3f(0.258824,0.258824,0.435294);
	glBegin(GL_POLYGON);
		glVertex3f(-145,70,-100);
		glVertex3f(-180,90,-120);
		glVertex3f(-180,90,-430);
		glVertex3f(-145,70,-460);
	glEnd();
	glBegin(GL_POLYGON);
		glVertex3f(-215,70,-100);
		glVertex3f(-180,90,-120);
		glVertex3f(-180,90,-430);
		glVertex3f(-215,70,-460);
	glEnd();
	glBegin(GL_TRIANGLES);
		glVertex3f(-180,90,-120);
		glVertex3f(-215,70,-100);
